...
-- Standalone achievement catalog (no FK to user_master_data or other flows).
...
CREATE TABLE "user_master_data" (
  "master_data_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "user_sso" VARCHAR UNIQUE NOT NULL,
  "created_at" TIMESTAMP,
  "created_by" VARCHAR,
  "updated_at" TIMESTAMP,
...
-- Standalone: user achievement progress; linked to users and achievements only.
...
CREATE TABLE "user_preferences" (
  ...
  "room_updates" BOOLEAN DEFAULT true,
...
CREATE TABLE "mindmaps" (
  "mindmap_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "document_id" BIGINT,
  "user_sso" VARCHAR NOT NULL,
  "title" VARCHAR NOT NULL,
...
-- Combined: features (unlockable), feature flags (rollout), system settings (key-value). Use config_type: 'feature' | 'flag' | 'setting'.
...
ALTER TABLE "user_room_slots" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id") ON DELETE CASCADE;
