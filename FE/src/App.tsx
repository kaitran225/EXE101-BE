  ...
  return (
    <div className={isStandalone ? 'min-h-screen bg-neutral-100' : ''}>
      ...
      <Routes>
        ...
        <Route path="/welcome" element={<main className="p-4 md:p-6 md:py-8 max-w-[1200px] mx-auto min-h-[calc(100vh-4rem)]"><Welcome /></main>} />
        <Route path="/sign-up" element={<main className="p-4 md:p-6 md:py-8 max-w-[1200px] mx-auto min-h-[calc(100vh-4rem)]"><SignUp /></main>} />
        <Route path="/confirm-mail" element={<main className="p-4 md:p-6 md:py-8 max-w-[1200px] mx-auto min-h-[calc(100vh-4rem)]"><ConfirmMail /></main>} />
        <Route path="/reset-password" element={<main className="p-4 md:p-6 md:py-8 max-w-[1200px] mx-auto min-h-[calc(100vh-4rem)]"><ResetPassword /></main>} />
        ...
        <Route path="/meetings" element={<GuideLayout><MainMeetingBoard /></GuideLayout>} />
        <Route path="/sprint-board" element={<GuideLayout><SprintBoard /></GuideLayout>} />
        ...
        <Route path="/scrum-board" element={<GuideLayout><ScrumBoard /></GuideLayout>} />
