    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-neutral-200/80 shadow-sm">
      <nav className="flex flex-wrap items-center justify-between gap-3 px-4 py-2.5 md:px-6 md:gap-4 max-w-[1200px] mx-auto" aria-label="Main">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <Link to="/dashboard" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors duration-150">Product</Link>
          <Link to="/dashboard" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors duration-150">About us</Link>
          <Link to="/dashboard" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors duration-150">Contact</Link>
        </div>
