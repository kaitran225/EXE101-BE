...
export function DashboardHeader() {
  ...
  return (
    <header
      className="flex-shrink-0 flex items-center gap-2 px-4 md:px-5 py-2 bg-white/90 backdrop-blur-xl border border-neutral-200/80 rounded-2xl shadow-sm transition-shadow duration-200"
      role="banner"
    >
